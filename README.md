...
|--------|-----------|-------------|
| [projeto-cypress-saucedemo](https://github.com/felipenoite/projeto-cypress-saucedemo) | Automação E2E e API do SauceDemo com relatórios Allure e Mochawesome | Cypress · JavaScript · Allure |
...
🔌 Testes de API           ⚡ Testes de Performance
📋 BDD / Gherkin           🔄 CI/CD
```
